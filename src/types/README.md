The types in `AuthorityRecord.ts`, `CompanyRecord.ts`, `CompanyPack.ts`, and `ObsoleteRecord.ts` are automatically generated using [quicktype](https://github.com/quicktype/quicktype) like so:
